...
*/
#define ID_CaeUnsPrint3D  50
{
    /*== CAEP_FORMATINFO FormatInfo */
    {   PWP_SITE_GROUPNAME,     /* const char *group */
        "Print 3D",             /* const char *name */
        MAKEGUID(ID_CaeUnsPrint3D),  /* PWP_UINT32 id */
    ...
    CaeUnsPrint3DBCInfo,            /* CAEP_BCINFO* */
    ARRAYSIZE(CaeUnsPrint3DBCInfo), /* PWP_UINT32 BCCnt */

    /*== CAEP_VCINFO*    pVCInfo;    -- array of format VCs or NULL */
    /*== PWP_UINT32      VCCnt;      -- # format VCs */
    CaeUnsPrint3DVCInfo,            /* CAEP_VCINFO* pVCInfo */
    ARRAYSIZE(CaeUnsPrint3DVCInfo), /* PWP_UINT32 VCCnt */

    /*== const char**    pFileExt;   -- array of valid file extensions */
    /*== PWP_UINT32      ExtCnt;     -- # valid file extensions */
    CaeUnsPrint3DFileExt,            /* const char **pFileExt */
    ARRAYSIZE(CaeUnsPrint3DFileExt), /* PWP_UINT32 ExtCnt */
